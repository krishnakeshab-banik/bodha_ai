...
describe.skipIf(!live)('live scrape integration (set LIVE_SCRAPE=1)', () => {
  ...
  it('Amazon.in returns at least one priced listing', async () => {
  ...
  it('Flipkart returns at least one priced listing', async () => {
  ...
  it('Snapdeal returns at least one priced listing', async () => {
