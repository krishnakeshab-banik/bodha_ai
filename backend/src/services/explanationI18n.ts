...
export function localizeExplanation(
  ...
  const profitAtList =
    language === 'hi'
      ? 'आपकी ' +
        listed +
        ' कीमत पर, कमीशन (और उस पर GST), शिपिंग और निर्माण लागत के बाद अनुमानित लाभ लगभग ' +
        profit +
        ' प्रति यूनिट है। '
      : 'உங்கள் ' +
        listed +
        ' விலையில், கமிஷன் (மற்றும் அதற்கான GST), ஷிப்பிங் மற்றும் உற்பத்திச் செலவுக்குப் பிறகு மதிப்பிடப்பட்ட லாபம் ஒரு அலகுக்கு சுமார் ' +
        profit +
        '. ';
  ...
  if (platform.lossRiskAvoided) {
    if (language === 'hi') {
      return (
        ...
        market +
        sample +
        ' पर बिकते हैं, जो कमीशन (और GST) और शिपिंग के बाद आपके ब्रेक-ईवन ' +
        floor +
    ...
    return (
      ...
      market +
      sample +
      'க்கு விற்கப்படுகின்றன, இது கமிஷன் (மற்றும் GST) மற்றும் ஷிப்பிங்கிற்குப் பிறகு உங்கள் இலாப-இழப்பு புள்ளி ' +
      floor +
